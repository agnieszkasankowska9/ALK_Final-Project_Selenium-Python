...
class Locators:
    ...
    # NO_ADDRESS_BANNER = (By.XPATH, '//*[@class="alert alert-warning"]')
    # ADDRESS_BLOCK = (By.XPATH, '//*[@id="center_column"]/div[1]/div/div/ul')
...
class AddressesPage(BasePage):
    ...
    def get_added_address_tile(self):
        ...
        """
        return self.driver.find_element(*Locators.ADDED_ADDRESS_TITLE).text

    def get_added_company(self):
        """
        Get added company
        """
        return self.driver.find_element(*Locators.ADDED_COMPANY).text

    def get_added_address(self):
        """
        Get added address
        """
        return self.driver.find_element(*Locators.ADDED_ADDRESS).text

    def get_added_address_line_2(self):
        """
        Get added address (line 2)
        """
        return self.driver.find_element(*Locators.ADDED_ADDRESS_LINE_2).text

    def get_added_city(self):
        """
        Get added City
        """
        return self.driver.find_element(*Locators.ADDED_CITY).text

    def get_added_state(self):
        """
        Get added State
        """
        return self.driver.find_element(*Locators.ADDED_STATE).text

    def get_added_zip_postal_code(self):
        """
        Get added Zip/Postal Code
        """
        return self.driver.find_element(*Locators.ADDED_ZIP_POSTAL_CODE).text

    def get_added_country(self):
        """
        Get added Country
        """
        return self.driver.find_element(*Locators.ADDED_COUNTRY).text

    def get_added_home_phone(self):
        """
        Get added home phone
        """
        return self.driver.find_element(*Locators.ADDED_HOME_PHONE).text

    def get_added_mobile_phone(self):
        """
        Get added mobile phone
        """
        return self.driver.find_element(*Locators.ADDED_MOBILE_PHONE).text
    ...
    def go_back_to_my_account(self):
        ...
        self.driver.find_element(*Locators.BACK_TO_YOUR_ACCOUNT).click()
